...
public class MinesweeperGame extends Game {
    ...
    private void openTile(int x, int y) {
        ...
        if (countMinesOnField == countClosedTiles && !gameObject.isMine) win();
        if (gameObject.isOpen && !gameObject.isMine) score+=5;
        setScore(score);
    }
    ...
    private void gameOver() {
        isGameStopped = true;
        showMessageDialog(Color.BLACK, "Конец игры", Color.YELLOW, 16);
    }

    private void win() {
        isGameStopped = true;
        showMessageDialog(Color.BLACK, "Победа", Color.YELLOW, 16);
    }
